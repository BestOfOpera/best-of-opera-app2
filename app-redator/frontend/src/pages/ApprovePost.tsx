...
export default function ApprovePost() {
  ...
  return (
    <div>
      ...
      <h3 style={{ marginBottom: 16 }}>Etapa 3 — Aprovar Post</h3>
      ...
      <div className="card" style={{ marginBottom: 16 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
          <label style={{ fontSize: 13, fontWeight: 500, color: 'var(--text-light)' }}>Texto do Post</label>
      ...
      <div className="card" style={{ marginBottom: 16, background: '#FAFAFA' }}>
        <h4 style={{ fontSize: 14, color: 'var(--text-light)', marginBottom: 12 }}>Pré-visualização</h4>
