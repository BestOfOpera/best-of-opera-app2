...
| curadoria (portal) | `b8fe934d-e3d7-4d30-a68a-4914e03cdb0a` | https://curadoria-production-cf4a.up.railway.app |
...
> ⚠️ O Railway CLI NÃO funciona com Account Tokens (UUID). Use sempre a API GraphQL.
